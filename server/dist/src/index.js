...
router.get('/api/worldMaps', maps_1.worldMapsWithoutImages);
router.get('/api/locationMaps', maps_1.locationMapsWithoutImages);
router.get('/api/worldMaps/tags', maps_1.worldMapByTag);
router.get('/api/locationMaps/tags', maps_1.locationMapByTag);
router.get('/api/tags', maps_1.tags);
