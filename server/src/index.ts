...
import { worldMapByName, locationMapByName, worldMapById, locationMapById, worldMapsWithoutImages, locationMapsWithoutImages, worldMapByTag, locationMapByTag, tags, uploadWorldMap, uploadLocationMap, uploadMap } from "./controllers/maps"
...
router.get('/api/worldMaps', worldMapsWithoutImages);

router.get('/api/locationMaps', locationMapsWithoutImages);
